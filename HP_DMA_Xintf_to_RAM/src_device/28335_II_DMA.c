...
void DMACH1AddrConfig(volatile Uint16 *DMA_Dest,volatile Uint16 *DMA_Source)
{
	...
	//DmaRegs.CH1.SRC_BEG_ADDR_SHADOW = (Uint32)DMA_Source;	// if not used in wrap type, this can be ignored
	DmaRegs.CH1.SRC_ADDR_SHADOW =     (Uint32)DMA_Source;

	// Set up DESTINATION address:
	//DmaRegs.CH1.DST_BEG_ADDR_SHADOW = (Uint32)DMA_Dest;	// if not used in wrap type, this can be ignored

...
const struct PIE_VECT_TABLE PieVectTableInit = {
      ...
      Reset_ISR,  // 0  Reserved space
      INT1_ISR,  // 1  Reserved space 
      INT2_ISR,  // 2  Reserved space 
      INT3_ISR,  // 3  Reserved space 
      INT4_ISR,  // 4  Reserved space 
      INT5_ISR,  // 5  Reserved space 
      INT6_ISR,  // 6  Reserved space 
      INT7_ISR,  // 7  Reserved space 
      INT8_ISR,  // 8  Reserved space 
      INT9_ISR,  // 9  Reserved space 
      INT10_ISR,  // 10 Reserved space 
      INT11_ISR,  // 11 Reserved space 
      INT12_ISR,  // 12 Reserved space 

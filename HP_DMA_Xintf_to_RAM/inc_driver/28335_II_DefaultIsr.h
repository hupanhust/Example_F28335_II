...
#ifndef _28335_II_DEFAULT_ISR_H
#define _28335_II_DEFAULT_ISR_H
...
interrupt void INT1_ISR(void);      // Reserved for test
interrupt void INT2_ISR(void);      // Reserved for test
interrupt void INT3_ISR(void);      // Reserved for test
interrupt void INT4_ISR(void);      // Reserved for test
interrupt void INT5_ISR(void);      // Reserved for test
interrupt void INT6_ISR(void);      // Reserved for test
interrupt void INT7_ISR(void);      // Reserved for test
interrupt void INT8_ISR(void);      // Reserved for test
interrupt void INT9_ISR(void);      // Reserved for test
interrupt void INT10_ISR(void);     // Reserved for test
interrupt void INT11_ISR(void);     // Reserved for test
interrupt void INT12_ISR(void);     // Reserved for test
